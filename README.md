...
📊 Atualmente atuo como **Analista de Dados**, desenvolvendo soluções voltadas para Business Intelligence, análise de indicadores e automação de processos.

💡 Tenho paixão por transformar dados em informação estratégica e criar soluções que geram valor para o negócio.

🚀 Sempre estudando novas tecnologias relacionadas a:
